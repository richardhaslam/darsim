                ...
                for i = 1:obj.NofPhases
                    ...
                    if ~isempty(indices_f)
                        for n = 1:length(indices_f)
                            ...
                            % adding to Jp_F2F1
                            row_ind_Jp = obj.NofPhases*( Nm + sum(Nf(1:Index_frac2_Local.f-1)) ) + (i-1)*(Nf(Index_frac2_Local.f)) + Index_frac2_Local.g;
                            col_ind_Jp = obj.NofPhases*( Nm + sum(Nf(1:Index_frac1_Local.f-1)) ) +                                 + Index_frac1_Local.g;
                             Jacobian(row_ind_Jp, col_ind_Jp) = Jp_frac_frac;
                            % adding to Jp_F2F2
                            row_ind_Jp = obj.NofPhases*( Nm + sum(Nf(1:Index_frac2_Local.f-1)) ) + (i-1)*(Nf(Index_frac2_Local.f)) + Index_frac2_Local.g;
                            ...
                            % adding to Js_F2F2
                            row_ind_Js = obj.NofPhases*( Nm + sum(Nf(1:Index_frac2_Local.f-1)) ) + (i-1)*(Nf(Index_frac2_Local.f)) + Index_frac2_Local.g;
                            col_ind_Js = obj.NofPhases*( Nm + sum(Nf(1:Index_frac2_Local.f-1)) ) +     1*(Nf(Index_frac2_Local.f)) + Index_frac2_Local.g;
                            ...
                            % adding to Js_F2F1
                            row_ind_Js = obj.NofPhases*( Nm + sum(Nf(1:Index_frac2_Local.f-1)) ) + (i-1)*(Nf(Index_frac2_Local.f)) + Index_frac2_Local.g;
                            col_ind_Js = obj.NofPhases*( Nm + sum(Nf(1:Index_frac1_Local.f-1)) ) +    1 *(Nf(Index_frac1_Local.f)) + Index_frac1_Local.g;
                            Jacobian(row_ind_Js, col_ind_Js) = Js_frac1_frac2;
                            % adding to Js_F1F1
                            row_ind_Js = obj.NofPhases*( Nm + sum(Nf(1:Index_frac1_Local.f-1)) ) + (i-1)*(Nf(Index_frac1_Local.f)) + Index_frac1_Local.g;
                            col_ind_Js = obj.NofPhases*( Nm + sum(Nf(1:Index_frac1_Local.f-1)) ) +    1 *(Nf(Index_frac1_Local.f)) + Index_frac1_Local.g;
                            Jacobian(row_ind_Js, col_ind_Js) = Jacobian(row_ind_Js, col_ind_Js) - Js_frac1_frac2;
                        end
                    end
                end
