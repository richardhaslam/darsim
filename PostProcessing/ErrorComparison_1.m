...
Bilin2L.P = X';
fclose(file);
% file = fopen(strcat('../ResultsAndImages/PressureConstrained/DARSim1/ADM/', DS,'/Constant_3Levels/Pressure.txt'), 'r');
% X = fscanf(file, '%f %f %f %f %f %f %f %f %f %f', [10 Inf]);
% Const3L.P = X';
% fclose(file);
% file = fopen(strcat('../ResultsAndImages/PressureConstrained/DARSim1/ADM/', DS, '/Bilinear_3Levels/Pressure.txt'), 'r');
% X = fscanf(file, '%f %f %f %f %f %f %f %f %f %f', [10 Inf]);
% Bilin3L.P = X';
% fclose(file);
%Saturation
...
Bilin2L.S = X';
fclose(file);
% file = fopen(strcat('../ResultsAndImages/PressureConstrained/DARSim1/ADM/', DS, '/Constant_3Levels/Saturation.txt'), 'r');
% X = fscanf(file, '%f %f %f %f %f %f %f %f %f %f', [10 Inf]);
% Const3L.S = X';
% fclose(file);
% file = fopen(strcat('../ResultsAndImages/PressureConstrained/DARSim1/ADM/', DS, '/Bilinear_3Levels/Saturation.txt'), 'r');
% X = fscanf(file, '%f %f %f %f %f %f %f %f %f %f', [10 Inf]);
% Bilin3L.S = X';
% fclose(file);
%Stats
file = strcat('../ResultsAndImages/PressureConstrained/',Problem,'/FIM/FIMStat.txt');
FineGrid.Stats = load(file);
file = strcat('../ResultsAndImages/PressureConstrained/',Problem,'/ADM/', DS, '/Constant_2Levels/DLGRStat.txt');
Const2L.Stats = load(file);
file = strcat('../ResultsAndImages/PressureConstrained/',Problem,'/ADM/', DS, '/Bilinear_2Levels/DLGRStat.txt');
Bilin2L.Stats = load(file);
% file = strcat('../ResultsAndImages/PressureConstrained/DARSim1/ADM/', DS, '/Constant_3Levels/DLGRStat.txt');
% Const3L.Stats = load(file);
% file = strcat('../ResultsAndImages/PressureConstrained/DARSim1/ADM/', DS, '/Bilinear_3Levels/DLGRStat.txt');
...
FineCells = 11664;
Const2L.Stats(:, 4) = Const2L.Stats(:, 4)./FineCells.*100; 
Bilin2L.Stats(:, 4) = Bilin2L.Stats(:, 4)./FineCells.*100;
...
file = fopen(strcat('../ResultsAndImages/PressureConstrained/',Problem,'/ADM/', DS, '/Constant_2Levels/DARSim1Const2L_AN_', DS, '.dat'), 'w');
fprintf(file, '%10.5f %10.5f\n', [Const2L.Stats(:,1), Const2L.Stats(:,4)]');
fclose(file);
file = fopen(strcat('../ResultsAndImages/PressureConstrained/',Problem,'/ADM/', DS, '/Bilinear_2Levels/DARSim1Bilin2L_AN_', DS, '.dat'), 'w');
fprintf(file, '%10.5f %10.5f\n', [Bilin2L.Stats(:,1), Bilin2L.Stats(:,4)]');
fclose(file);
% file = fopen(strcat('../ResultsAndImages/PressureConstrained/DARSim1/ADM/', DS, '/Constant_3Levels/DARSim1Const3L_AN_', DS, '.dat'), 'w');
% fprintf(file, '%10.5f %10.5f\n', [Const3L.Stats(:,1), Const3L.Stats(:,4)]');
% fclose(file);
% file = fopen(strcat('../ResultsAndImages/PressureConstrained/DARSim1/ADM/', DS, '/Bilinear_3Levels/DARSim1Bilin3L_AN_', DS, '.dat'), 'w');
...
file = fopen(strcat('../ResultsAndImages/PressureConstrained/',Problem,'/ADM/', DS, '/',Problem,'_', DS, '.dat'), 'w');
