...
classdef reader_darsim2 < reader
    ...
    methods
        ...
        function CornerPointGridData = ReadCornerPointGridData(obj)
            ...
            splitStr = regexp(TEMP, ',', 'split');
            splitStr = str2double( vertcat( splitStr{:} ) );
            Cell.SW_Bot_Corner = splitStr(:,2);
            Cell.SE_Bot_Corner = splitStr(:,3);
            Cell.NE_Bot_Corner = splitStr(:,4);
            Cell.NW_Bot_Corner = splitStr(:,5);
            Cell.SW_Top_Corner = splitStr(:,6);
            Cell.SE_Top_Corner = splitStr(:,7);
            Cell.NE_Top_Corner = splitStr(:,8);
            Cell.NW_Top_Corner = splitStr(:,9);
