...
Directory_noPc_dz2 = '../Results/4_Papers_Results/AWR_paper/Case4/AWR_Case4_noPc_ADM_dz2/Output/';
Directory_Pc_dz1 = '../Results/4_Papers_Results/AWR_paper/Case4/AWR_Case4_ADM/Output/';
Directory_Pc_dz2 = '../Results/4_Papers_Results/AWR_paper/Case4/AWR_Case4_ADM_dz2/Output/';
...
fid = fopen(strcat('Nodes_Case4_noPc_dz2.txt'), 'w');
...
fid = fopen(strcat('Nodes_Case4_Pc_dz2.txt'), 'w');
