...
fprintf(file, '%20s %10.2f %10.2f \n', '% active nodes', [mean(Const2L.Stats(:,4)), mean(Bilin2L.Stats(:,4))]);
fprintf(file, '%20s %10.0f %10.0f \n', 'NnLinear', [Const2L_nl, Bilin2L_nl]);
fprintf(file, '%20s %10.5f %10.5f \n', 'Pressure error', [Const2L_EP, Bilin2L_EP]);
fprintf(file, '%20s %10.5f %10.5f \n', 'Saturation error', [Const2L_ES, Bilin2L_ES]);
fclose(file);