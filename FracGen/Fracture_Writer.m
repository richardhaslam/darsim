...
elseif obj.Simulation.Domain == '3D'
    ...
    for f = 1 : length(obj.Simulation.Fractures)
        ...
        fprintf(fid, 'PROPERTIES    %2.0f         %1.3e     %1.3e     %1.4e      %1.4e     %1.4e        %1.0fx%1.0f             [%1.0f,%1.0f,%1.0f,%1.0f]                                                                                          [%1.5e;%1.5e;%1.5e] , [%1.5e;%1.5e;%1.5e] , [%1.5e;%1.5e;%1.5e] , [%1.5e;%1.5e;%1.5e]\n' , ...
                f-1 , obj.Simulation.Fractures(f).Length_AB   , obj.Simulation.Fractures(f).Width_AD , obj.Simulation.Fractures(f).Aperture , obj.Simulation.Fractures(f).Porosity , ...
                     ...
                     obj.Simulation.Fractures(f).ADM(1)       , obj.Simulation.Fractures(f).ADM(2) , obj.Simulation.Fractures(f).ADM(3) , obj.Simulation.Fractures(f).ADM(4) , ...
